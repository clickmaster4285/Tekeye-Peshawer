...
from .views import (
    ...
    VisitorFaceEnrollAPIView,
    VisitorFaceListAPIView,
    VisitorFaceDeleteAPIView,
    VisitorFaceRecognizeAPIView,
...
urlpatterns = [
    ...
    path("visitors/face/recognize/", VisitorFaceRecognizeAPIView.as_view(), name="visitor-face-recognize"),
    ...
    path("visitors/<int:pk>/face/enroll/", VisitorFaceEnrollAPIView.as_view(), name="visitor-face-enroll"),
    path("visitors/<int:pk>/faces/", VisitorFaceListAPIView.as_view(), name="visitor-face-list"),
    path(
        "visitors/<int:pk>/faces/<int:face_id>/",
        VisitorFaceDeleteAPIView.as_view(),
        name="visitor-face-delete",
    ),
