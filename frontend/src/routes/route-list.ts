...
export const DASHBOARD_ROUTES: { index?: true; path?: string; page: string }[] = [
  ...
  { path: toChildPath(ROUTES.VIDEO_RECOVERY), page: "VideoRecovery" },
  ...
  { path: "vehicle-journey/:plateKey", page: "VehicleJourneyDetail" },
  { path: toChildPath(ROUTES.NUMBER_PLATE_DETECTION), page: "NumberPlateDetection" },
  { path: toChildPath(ROUTES.NUMBER_PLATE_DETECTION_LEGACY), page: "NumberPlateDetection" },
  ...
  { path: toChildPath(ROUTES.INFRASTRUCTURE_OVERVIEW), page: "InfrastructureOverview" },
  { path: toChildPath(ROUTES.INFRASTRUCTURE_CAMERAS), page: "InfrastructureCameras" },
  { path: toChildPath(ROUTES.INFRASTRUCTURE_CAMERA_DETAIL), page: "InfrastructureCameraDetail" },
  { path: toChildPath(ROUTES.INFRASTRUCTURE_NVRS), page: "InfrastructureNvrs" },
  { path: toChildPath(ROUTES.INFRASTRUCTURE_NVR_DETAIL), page: "InfrastructureNvrDetail" },
  { path: toChildPath(ROUTES.INFRASTRUCTURE_UPS), page: "InfrastructureUps" },
  { path: toChildPath(ROUTES.INFRASTRUCTURE_INVERTERS), page: "InfrastructureInverters" },
  { path: toChildPath(ROUTES.INFRASTRUCTURE_NETWORK), page: "InfrastructureNetwork" },
  { path: toChildPath(ROUTES.INFRASTRUCTURE_SERVERS), page: "InfrastructureServers" },
  { path: toChildPath(ROUTES.INFRASTRUCTURE_SERVER_DETAIL), page: "InfrastructureServerDetail" },
  { path: toChildPath(ROUTES.INFRASTRUCTURE_DEVICE_HEALTH), page: "InfrastructureDeviceHealth" },
  { path: toChildPath(ROUTES.INFRASTRUCTURE_POWER), page: "InfrastructurePower" },
